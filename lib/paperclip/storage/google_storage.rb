module Paperclip
  module Storage
    ...
    # * +google_storage_credentials+: Takes a path, a File, or a Hash. The path (or File) must point
    ...
    #   policies that Google Storage provides (more information can be found here:
    #   http://code.google.com/apis/storage/docs/developer-guide.html#authorization)
    #   The default for Paperclip is :public_read.
    # * +google_storage_protocol+: The protocol for the URLs generated to your Google Storage assets. Can be either
    ...
    # * +google_storage_headers+: TODO - Add support and docs for headers
    # * +bucket+: This is the name of the Google Storage bucket that will store your files. If the bucket does not exist
    ...
    module Googlestorage
      def self.extended base
        begin
          ...
          e.message << " (You may need to install the gstore gem)"
          raise e
        end
